...
export function Sidebar() {
  ...
  useEffect(() => {
    if (pathname === "/messages") {
      ...
      if (activeTab === "messages" || activeTab === "cancellations" || activeTab === "cx-dashboard") {
  ...
  const handlePageClick = (pageId: string, pageHref: string) => {
    ...
    setExpanded(pageId)
    setActiveTab(pageId === "messages" ? "messages" : pageId === "cancellations" ? "cancellations" : pageId === "cx-dashboard" ? "cx-dashboard" : "dashboard")
  }
